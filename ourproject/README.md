...
- Đối với user (học sinh) : đăng ký , đăng nhập , tạo và cập nhật hồ sơ cá nhân , tra cứu chọn lọc ngành trường , lưu danh sách yêu thích , theo dõi tin tức thông tin tuyển sinh.
- Đối với admin : quản lý trường, quản lý người dùng , cập nhật tin tức.
-Phòng học : tạo,thêm,cập nhật và xoá phòng học trong trường đại học
Cụ thể hơn:
